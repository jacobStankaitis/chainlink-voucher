  ...
  return (
    <main className="container">
      ...
      <h2 className="mb-lg-5 mb-3 text-center">
        Chainlink Payment Vouchers
      </h2>
      <div className="landing-top">
        <div>
          <p className="mt-2 pt-3">
            <b>Extend the finance management with CHAINLINK Payment Vouchers!</b>
          </p>
          <p>Lock your USDC tokens using our smart contract and receive unique voucher that can be used by scan QR-code or follow URL to get locked
            tokens.</p>
        ...
        <div className="col-10 offset-1 mt-2">
          <div className="row">
            <div className="col-4">
              ...
              <div>Chainlink Blockchain - scalable and fast solution with low transaction fees without ever sacrificing on security.</div>
            </div>
            <div className="col-4">
